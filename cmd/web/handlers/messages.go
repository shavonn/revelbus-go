...
const (
	...
	MsgInvalidCredentials      = "Invalid login credentials."
	MsgInvalidRecovery         = "Invalid recovery. Please try again."
	MsgMustBeAdmin             = "Must be admin user to do that!"
	MsgMustBeLoggedIn          = "Must be logged in to do that!"
